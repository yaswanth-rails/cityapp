...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddUpdateListPageModule", function() { return AddUpdateListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_updatelist__ = __webpack_require__(1164);
...
var AddUpdateListPageModule = (function () {
    function AddUpdateListPageModule() {
    }
    AddUpdateListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__add_updatelist__["a" /* AddUpdateListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_updatelist__["a" /* AddUpdateListPage */]),
    ...
    ], AddUpdateListPageModule);
    return AddUpdateListPageModule;
}());

//# sourceMappingURL=add-updatelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddUpdateListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_updatelist_service__ = __webpack_require__(647);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_cityupdate__ = __webpack_require__(659);
...
var AddUpdateListPage = (function (_super) {
    __extends(AddUpdateListPage, _super);
    function AddUpdateListPage(injector, camera, geolocation, updateService, actionSheetCtrl, popoverCtrl) {
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormGroup */]({
            ...
            cityupdate: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["g" /* Validators */].required),
    ...
    AddUpdateListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    AddUpdateListPage.prototype.ionViewDidLoad = function () {
    ...
    AddUpdateListPage.prototype.openPopover = function (myEvent) {
    ...
    AddUpdateListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.updateService.load().then(function (cityupdate) {
            _this.cityupdate = cityupdate;
        }).catch(function (err) { return console.warn(err.message); });
    };
    AddUpdateListPage.prototype.loadGoogleMaps = function () {
        var _this = this;
    ...
    AddUpdateListPage.prototype.initMap = function () {
    ...
    AddUpdateListPage.prototype.onSearchAddress = function (event) {
        var _this = this;
    ...
    AddUpdateListPage.prototype.chooseImage = function (sourceType) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddUpdateListPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddUpdateListPage.prototype.prepareUpdateListData = function () {
        var updatelist = new __WEBPACK_IMPORTED_MODULE_3__providers_updatelist_service__["a" /* UpdateList */];
        updatelist.title = this.form.value.name;
        updatelist.cityupdate = this.form.value.cityupdate;
        updatelist.description = this.form.value.description;
        updatelist.address = this.form.value.address;
        updatelist.website = this.form.value.website;
        updatelist.phone = this.form.value.phone;
        updatelist.image = this.image;
        if (this.location) {
            var position = {
                lat: this.location.lat,
                lng: this.location.lng
            };
            updatelist.location = position;
        }
        return updatelist;
    };
    AddUpdateListPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, trans, trans, updatelist, trans, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        _a.sent();
                        updatelist = this.prepareUpdateListData();
                        return [4 /*yield*/, updatelist.save()];
                    case 8:
                        _a.sent();
                        this.form.reset();
