...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CityUpdatePageModule", function() { return CityUpdatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cityupdate__ = __webpack_require__(1168);
...
var CityUpdatePageModule = (function () {
    function CityUpdatePageModule() {
    }
    CityUpdatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__cityupdate__["a" /* CityUpdatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__cityupdate__["a" /* CityUpdatePage */]),
    ...
    ], CityUpdatePageModule);
    return CityUpdatePageModule;
}());

//# sourceMappingURL=cityupdate.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CityUpdatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_cityupdate__ = __webpack_require__(659);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_user_service__ = __webpack_require__(148);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__concion_popover_concion_popover__ = __webpack_require__(632);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_animations__ = __webpack_require__(255);
...
var CityUpdatePage = (function (_super) {
    __extends(CityUpdatePage, _super);
    function CityUpdatePage(injector, events, popoverCtrl, renderer, cityupdateService) {
        var _this = _super.call(this, injector) || this;
        _this.events = events;
        _this.popoverCtrl = popoverCtrl;
        _this.renderer = renderer;
        _this.cityupdateService = cityupdateService;
        _this.cityupdate = [];
        return _this;
    }
    CityUpdatePage.prototype.enableMenuSwipe = function () {
        return true;
    };
    CityUpdatePage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.loadData();
    };
    CityUpdatePage.prototype.goToCityUpdateList = function (cityupdate) {
        this.navigateTo('UpdateListPage', { cityupdate: cityupdate });
    };
    CityUpdatePage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    CityUpdatePage.prototype.loadData = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.cityupdateService.load()];
                    case 1:
                        _a.cityupdate = _b.sent();
    ...
    CityUpdatePage.prototype.openPopover = function (myEvent) {
        //this.navctrl.setRoot(CancionPopoverPage,{event})
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_5__concion_popover_concion_popover__["a" /* CancionPopoverPage */]);
        popover.present({
            ev: myEvent
        });
    };
    CityUpdatePage.prototype.onReload = function (refresher) {
        this.refresher = refresher;
        this.loadData();
    };
    CityUpdatePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-cityupdate',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/cityupdate/cityupdate.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    \n     <ion-buttons end>\n     <a ion-button icon-only (click)="openPopover($event)">\n      <ion-icon name="md-happy"></ion-icon>\n    </a>\n    </ion-buttons>\n    <ion-title>{{ \'CITYUPDATE\' | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <empty-view *ngIf="isErrorViewVisible" icon="alert"\n    [text]="\'ERROR_NETWORK\' | translate">\n  </empty-view>\n\n  <empty-view *ngIf="isEmptyViewVisible" icon="bookmark"\n    [text]="\'EMPTY_CATEGORIES\' | translate">\n  </empty-view>\n\n  <ion-refresher (ionRefresh)="onReload($event)">\n    <ion-refresher-content\n      pullingText="{{ \'PULL_TO_REFRESH\' | translate }}"\n      refreshingText="{{ \'REFRESHING\' | translate }}">\n    </ion-refresher-content>\n  </ion-refresher>\n\n  <!-- <div [@staggerIn]="cityupdate.length">\n    <div class="card-img" *ngFor="let cityupdate of cityupdate" (click)="goToCityUpdateList(cityupdate)">\n      <img-loader [src]="cityupdate.image.url()" (load)="onImageLoad($event)"></img-loader>\n      <div>\n        <h5 class="bold" ion-text color="light">{{ cityupdate.title }}</h5>\n        <span class="gradient-bg bold" ion-text color="light">\n          {{ cityupdate.cityupdatelistCount }} {{ \'PLACES\' | translate }}\n        </span>\n      </div>\n    </div>\n  </div> -->\n    <ion-list *ngIf="isContentViewVisible">\n    <ion-item *ngFor="let cityupdate of cityupdate" (click)="goToCityUpdateList(cityupdate)">\n      <ion-avatar item-left>\n        <img src="assets/img/tag.png" offset="100"\n          [lazyLoad]="cityupdate.imageThumb.url()"\n          [scrollTarget]="container.getScrollElement()">\n      </ion-avatar>\n      <h2>{{ cityupdate.title }}</h2>\n    </ion-item>\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/cityupdate/cityupdate.html"*/,
            animations: [
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_cityupdate__["a" /* CityUpdate */]])
    ], CityUpdatePage);
    return CityUpdatePage;
