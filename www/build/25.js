...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sale__ = __webpack_require__(1201);
...
var SalePageModule = (function () {
    ...
    SalePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__sale__["a" /* SalePage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_sale__ = __webpack_require__(658);
...
var SalePage = (function (_super) {
    __extends(SalePage, _super);
    function SalePage(injector, events, renderer, popoverCtrl, saleService) {
    ...
    SalePage.prototype.enableMenuSwipe = function () {
        return true;
    };
    ...
    SalePage.prototype.goToSaleList = function (sale) {
        this.navigateTo('SaleListPage', { sale: sale });
    };
    SalePage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    SalePage.prototype.openPopover = function (myEvent) {
    ...
    SalePage.prototype.loadData = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.saleService.load()];
                    case 1:
                        _a.sale = _b.sent();
                        if (this.sale.length) {
    ...
    SalePage.prototype.onReload = function (refresher) {
        this.refresher = refresher;
        this.loadData();
    };
    SalePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-sale',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/sale/sale.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>{{ \'SALE\' | translate }}</ion-title>\n    \n\n     <ion-buttons end>\n     <a ion-button icon-only (click)="openPopover($event)">\n      <ion-icon name="md-happy"></ion-icon>\n    </a>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <empty-view *ngIf="isErrorViewVisible" icon="alert"\n    [text]="\'ERROR_NETWORK\' | translate">\n  </empty-view>\n\n  <empty-view *ngIf="isEmptyViewVisible" icon="bookmark"\n    [text]="\'EMPTY_CATEGORIES\' | translate">\n  </empty-view>\n\n  <ion-refresher (ionRefresh)="onReload($event)">\n    <ion-refresher-content\n      pullingText="{{ \'PULL_TO_REFRESH\' | translate }}"\n      refreshingText="{{ \'REFRESHING\' | translate }}">\n    </ion-refresher-content>\n  </ion-refresher>\n\n  <!-- <div [@staggerIn]="sale.length">\n    <div class="card-img" *ngFor="let sale of sale" (click)="goToSaleList(sale)">\n      <img-loader [src]="sale.image.url()" (load)="onImageLoad($event)"></img-loader>\n      <div>\n        <h5 class="bold" ion-text color="light">{{ sale.title }}</h5>\n        <span class="gradient-bg bold" ion-text color="light">\n          {{ sale.salelistCount }} {{ \'PLACES\' | translate }}\n        </span>\n      </div>\n    </div>\n  </div> -->\n    <ion-list *ngIf="isContentViewVisible">\n    <ion-item *ngFor="let sale of sale" (click)="goToSaleList(sale)">\n      <ion-avatar item-left>\n        <img src="assets/img/tag.png" offset="100"\n          [lazyLoad]="sale.imageThumb.url()"\n          [scrollTarget]="container.getScrollElement()">\n      </ion-avatar>\n      <h2>{{ sale.title }}</h2>\n    </ion-item>\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/sale/sale.html"*/,
            animations: [
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_sale__["a" /* Sale */]])
    ], SalePage);
    return SalePage;
