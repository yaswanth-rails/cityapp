...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesSalePageModule", function() { return FavoritesSalePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_sale__ = __webpack_require__(1177);
...
var FavoritesSalePageModule = (function () {
    function FavoritesSalePageModule() {
    }
    FavoritesSalePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_sale__["a" /* FavoritesSale */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_sale__["a" /* FavoritesSale */]),
    ...
    ], FavoritesSalePageModule);
    return FavoritesSalePageModule;
}());

//# sourceMappingURL=favorite-sale.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesSale; });
...
var FavoritesSale = (function (_super) {
    __extends(FavoritesSale, _super);
    function FavoritesSale(injector, renderer, popoverCtrl, salelistService) {
    ...
    FavoritesSale.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesSale.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesSale.prototype.goToSaleList = function (salelist) {
        this.navigateTo('SaleListDetailPage', { salelist: salelist });
    };
    FavoritesSale.prototype.openPopover = function (myEvent) {
    ...
    FavoritesSale.prototype.loadData = function () {
        var _this = this;
        this.salelistService.loadFavorites(this.params).then(function (salelists) {
            for (var _i = 0, salelists_1 = salelists; _i < salelists_1.length; _i++) {
                var salelist = salelists_1[_i];
                _this.salelists.push(salelist);
            }
            _this.onRefreshComplete(salelists);
            if (_this.salelists.length) {
    ...
    FavoritesSale.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesSale.prototype.onReload = function (refresher) {
