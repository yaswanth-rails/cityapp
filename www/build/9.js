...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddRentListPageModule", function() { return AddRentListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_rentlist__ = __webpack_require__(1159);
...
var AddRentListPageModule = (function () {
    function AddRentListPageModule() {
    }
    AddRentListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__add_rentlist__["a" /* AddRentListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_rentlist__["a" /* AddRentListPage */]),
    ...
    ], AddRentListPageModule);
    return AddRentListPageModule;
}());

//# sourceMappingURL=add-rentlist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddRentListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rentlist_service__ = __webpack_require__(644);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_rent__ = __webpack_require__(657);
...
var AddRentListPage = (function (_super) {
    __extends(AddRentListPage, _super);
    function AddRentListPage(injector, camera, geolocation, rentService, actionSheetCtrl, popoverCtrl) {
        var _this = _super.call(this, injector) || this;
        _this.camera = camera;
        _this.geolocation = geolocation;
        _this.rentService = rentService;
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormGroup */]({
            ...
            rent: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["g" /* Validators */].required),
    ...
    AddRentListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    AddRentListPage.prototype.ionViewDidLoad = function () {
    ...
    AddRentListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.rentService.load().then(function (rent) {
            _this.rent = rent;
        }).catch(function (err) { return console.warn(err.message); });
    };
    AddRentListPage.prototype.openPopover = function (myEvent) {
    ...
    AddRentListPage.prototype.loadGoogleMaps = function () {
        var _this = this;
    ...
    AddRentListPage.prototype.initMap = function () {
    ...
    AddRentListPage.prototype.onSearchAddress = function (event) {
        var _this = this;
    ...
    AddRentListPage.prototype.chooseImage = function (sourceType) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddRentListPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddRentListPage.prototype.prepareRentListData = function () {
        var rentlist = new __WEBPACK_IMPORTED_MODULE_3__providers_rentlist_service__["a" /* RentList */];
    ...
    AddRentListPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, trans, trans, rentlist, trans, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        _a.sent();
                        rentlist = this.prepareRentListData();
                        return [4 /*yield*/, rentlist.save()];
                    case 8:
                        _a.sent();
                        this.form.reset();
