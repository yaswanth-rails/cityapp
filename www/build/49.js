...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesUpdatePageModule", function() { return FavoritesUpdatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_news__ = __webpack_require__(1173);
...
var FavoritesUpdatePageModule = (function () {
    function FavoritesUpdatePageModule() {
    }
    FavoritesUpdatePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_news__["a" /* FavoritesUpdatePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_news__["a" /* FavoritesUpdatePage */]),
    ...
    ], FavoritesUpdatePageModule);
    return FavoritesUpdatePageModule;
}());

//# sourceMappingURL=favorite-news.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesUpdatePage; });
...
var FavoritesUpdatePage = (function (_super) {
    __extends(FavoritesUpdatePage, _super);
    function FavoritesUpdatePage(injector, renderer, popoverCtrl, updatelistService) {
    ...
    FavoritesUpdatePage.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesUpdatePage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesUpdatePage.prototype.goToUpdate = function (updatelist) {
        this.navigateTo('UpdateListDetailPage', { updatelist: updatelist });
    };
    FavoritesUpdatePage.prototype.openPopover = function (myEvent) {
    ...
    FavoritesUpdatePage.prototype.loadData = function () {
        var _this = this;
        this.updatelistService.loadFavorites(this.params).then(function (updates) {
            for (var _i = 0, updates_1 = updates; _i < updates_1.length; _i++) {
                var update = updates_1[_i];
                _this.updatelist.push(update);
            }
            _this.onRefreshComplete(updates);
            if (_this.updatelist.length) {
    ...
    FavoritesUpdatePage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesUpdatePage.prototype.onReload = function (refresher) {
    ...
    return FavoritesUpdatePage;
}(__WEBPACK_IMPORTED_MODULE_3__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=favorite-news.js.map
