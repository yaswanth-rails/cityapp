...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SaleListReviewPageModule", function() { return SaleListReviewPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__salelistreview__ = __webpack_require__(1206);
...
var SaleListReviewPageModule = (function () {
    function SaleListReviewPageModule() {
    }
    SaleListReviewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__salelistreview__["a" /* SaleListReviewPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__salelistreview__["a" /* SaleListReviewPage */]),
    ...
    ], SaleListReviewPageModule);
    return SaleListReviewPageModule;
}());

//# sourceMappingURL=salelistreview.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SaleListReviewPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_salelistreview_service__ = __webpack_require__(651);
...
var SaleListReviewPage = (function (_super) {
    __extends(SaleListReviewPage, _super);
    function SaleListReviewPage(injector, salelistreviewService) {
        var _this = _super.call(this, injector) || this;
        _this.salelistreviewService = salelistreviewService;
        _this.params = {};
        _this.params.salelist = _this.navParams.data;
        return _this;
    }
    SaleListReviewPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    SaleListReviewPage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.onReload();
    };
    SaleListReviewPage.prototype.loadData = function () {
        var _this = this;
        this.salelistreviewService.load(this.params).then(function (salelistreviews) {
            for (var _i = 0, salelistreviews_1 = salelistreviews; _i < salelistreviews_1.length; _i++) {
                var salelistreview = salelistreviews_1[_i];
                _this.salelistreviews.push(salelistreview);
            }
            _this.onRefreshComplete(salelistreviews);
            if (_this.salelistreviews.length) {
    ...
    SaleListReviewPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    SaleListReviewPage.prototype.onReload = function (refresher) {
