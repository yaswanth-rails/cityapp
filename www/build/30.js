...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RentListDetailPageModule", function() { return RentListDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rentlist_detail__ = __webpack_require__(1197);
...
var RentListDetailPageModule = (function () {
    function RentListDetailPageModule() {
    }
    RentListDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__rentlist_detail__["a" /* RentListDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__rentlist_detail__["a" /* RentListDetailPage */]),
    ...
    ], RentListDetailPageModule);
    return RentListDetailPageModule;
}());

//# sourceMappingURL=rentlist-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RentListDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_rentlist_service__ = __webpack_require__(644);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_rentlistreview_service__ = __webpack_require__(652);
...
var RentListDetailPage = (function (_super) {
    __extends(RentListDetailPage, _super);
    function RentListDetailPage(injector, renderer, platform, rentlistService, modalCtrl, preference, callNumber, geolocation, inAppBrowser, browserTab, reviewService, launchNavigator, socialSharing) {
        var _this = _super.call(this, injector) || this;
        _this.renderer = renderer;
        _this.platform = platform;
        _this.rentlistService = rentlistService;
        ...
        _this.rentlistreview = [];
        _this.rentlist = _this.navParams.get('rentlist');
        console.log(_this.rentlist);
        _this.unit = _this.preference.unit;
        _this.images = [];
        if (_this.rentlist) {
            _this.rating = _this.rentlist.rating;
            _this.loadLocation();
            ...
            _this.loadReviews();
            if (_this.rentlist.image) {
                _this.images.push(_this.rentlist.image);
            }
            if (_this.rentlist.imageTwo) {
                _this.images.push(_this.rentlist.imageTwo);
            }
            if (_this.rentlist.imageThree) {
                _this.images.push(_this.rentlist.imageThree);
            }
            if (_this.rentlist.imageFour) {
                _this.images.push(_this.rentlist.imageFour);
            }
        }
        return _this;
    }
    RentListDetailPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    RentListDetailPage.prototype.ionViewDidLoad = function () {
    };
    RentListDetailPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    RentListDetailPage.prototype.checkIfIsLiked = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.rentlistService.isLiked(this.rentlist)];
                    case 1:
                        isLiked = _a.sent();
    ...
    RentListDetailPage.prototype.checkIfIsStarred = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isStarred, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.rentlistService.isStarred(this.rentlist)];
                    case 1:
                        isStarred = _a.sent();
    ...
    RentListDetailPage.prototype.loadLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RentListDetailPage.prototype.loadReviews = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rentlistreview, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.reviewService.load({ rentlist: this.rentlist, limit: 5 })];
                    case 1:
                        rentlistreview = _a.sent();
    ...
    RentListDetailPage.prototype.openSignUpModal = function () {
        this.navigateTo('SignInPage');
    };
    RentListDetailPage.prototype.openAddReviewModal = function () {
        var modal = this.modalCtrl.create('AddRentListReviewPage', { rentlist: this.rentlist });
        modal.present();
    };
    RentListDetailPage.prototype.onLike = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
            this.isLiked = true;
    ...
    RentListDetailPage.prototype.onRate = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
    ...
    RentListDetailPage.prototype.onShare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.socialSharing.share(this.rentlist.title, null, null, this.rentlist.website)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    RentListDetailPage.prototype.onCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.rentlist.phone)
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.callNumber.callNumber(this.rentlist.phone, true)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    RentListDetailPage.prototype.openUrl = function () {
        var _this = this;
        if (!this.rentlist.website)
            return;
        if (this.platform.is('cordova')) {
            this.browserTab.isAvailable().then(function (isAvailable) {
                if (isAvailable) {
                    _this.browserTab.openUrl(_this.rentlist.website);
                }
                else {
                    _this.inAppBrowser.create(_this.rentlist.website, '_system');
                }
    ...
    RentListDetailPage.prototype.goToMap = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    RentListDetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_rentlist_service__["a" /* RentList */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_rentlistreview_service__["a" /* RentListReview */],
    ...
    return RentListDetailPage;
}(__WEBPACK_IMPORTED_MODULE_10__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=rentlist-detail.js.map
