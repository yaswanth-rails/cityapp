...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sign_up_page__ = __webpack_require__(1209);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_firebase__ = __webpack_require__(660);
...
var SignUpPage = (function (_super) {
    ...
    function SignUpPage(injector, events, userService, viewCtrl, alertCtrl1) {
        var _this = _super.call(this, injector) || this;
        _this.events = events;
        _this.userService = userService;
        _this.viewCtrl = viewCtrl;
        _this.alertCtrl1 = alertCtrl1;
        _this.verificationId = '';
        _this.phoneNumber = '';
        _this.countryCode = '';
        _this.code = "";
    ...
    SignUpPage.prototype.presentPrompt = function () {
        var _this = this;
    ...
    SignUpPage.prototype.verify = function () {
        var _this = this;
        var credential = __WEBPACK_IMPORTED_MODULE_5_firebase__["auth"].PhoneAuthProvider.credential(this.verificationId, this.code);
        __WEBPACK_IMPORTED_MODULE_5_firebase__["auth"]().signInWithCredential(credential).then(function (res) {
            console.log('SCC', res);
            _this.onSubmit();
        }, function () {
    ...
    SignUpPage.prototype.finder = function () {
        var _this = this;
