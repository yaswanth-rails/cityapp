...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesPlacePageModule", function() { return FavoritesPlacePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_place__ = __webpack_require__(1174);
...
var FavoritesPlacePageModule = (function () {
    function FavoritesPlacePageModule() {
    }
    FavoritesPlacePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_place__["a" /* FavoritesPlacePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_place__["a" /* FavoritesPlacePage */]),
    ...
    ], FavoritesPlacePageModule);
    return FavoritesPlacePageModule;
}());

//# sourceMappingURL=favorite-place.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesPlacePage; });
...
var FavoritesPlacePage = (function (_super) {
    __extends(FavoritesPlacePage, _super);
    function FavoritesPlacePage(injector, renderer, popoverCtrl, placeService) {
    ...
    FavoritesPlacePage.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesPlacePage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesPlacePage.prototype.goToPlace = function (place) {
        this.navigateTo('PlaceDetailPage', { place: place });
    };
    FavoritesPlacePage.prototype.openPopover = function (myEvent) {
    ...
    FavoritesPlacePage.prototype.loadData = function () {
        var _this = this;
    ...
    FavoritesPlacePage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesPlacePage.prototype.onReload = function (refresher) {
    ...
    return FavoritesPlacePage;
}(__WEBPACK_IMPORTED_MODULE_3__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=favorite-place.js.map
