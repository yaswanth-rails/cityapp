...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__forgot_password__ = __webpack_require__(1178);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_sweetalert__ = __webpack_require__(1153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_firebase__ = __webpack_require__(660);
...
var ForgotPasswordPage = (function (_super) {
    ...
    function ForgotPasswordPage(injector, viewCtrl, userService, alertCtrl1) {
        var _this = _super.call(this, injector) || this;
        _this.viewCtrl = viewCtrl;
        _this.userService = userService;
        _this.alertCtrl1 = alertCtrl1;
        _this.navigateTo('ResetPage');
        _this.form = new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["b" /* FormGroup */]({
            ...
            username: new __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].compose([__WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].maxLength(10), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].pattern('[1-9]{1}[0-9]{9}'), __WEBPACK_IMPORTED_MODULE_2__angular_forms__["g" /* Validators */].required])),
        });
        return _this;
    }
    ...
    ForgotPasswordPage.prototype.finder = function () {
        var _this = this;
        var data = this.form.value;
        this.userService.find(data).then(function (data) {
            _this.result = data;
            if (_this.result.length != 0) {
                _this.send();
            }
            else {
                var alert_1 = _this.alertCtrl1.create({
                    title: 'Error',
    ...
    ForgotPasswordPage.prototype.send = function () {
        ...
        var phone = '+91' + this.form.value.username;
        window.FirebasePlugin.verifyPhoneNumber(phone, 30, function (credential) {
    ...
    ForgotPasswordPage.prototype.presentPrompt = function () {
        var _this = this;
        var alert = this.alertCtrl1.create({
            title: 'Enter OTP',
            inputs: [
                {
                    name: 'otp',
    ...
    ForgotPasswordPage.prototype.verify = function () {
        var _this = this;
        var credential = __WEBPACK_IMPORTED_MODULE_6_firebase__["auth"].PhoneAuthProvider.credential(this.verificationId, this.code);
        __WEBPACK_IMPORTED_MODULE_6_firebase__["auth"]().signInWithCredential(credential).then(function (res) {
            console.log('SCC', res);
            // this.onSubmit();  
    ...
    ForgotPasswordPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-forgot-password',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/forgot-password/forgot-password.html"*/'<ion-header no-border>\n  <ion-toolbar class="transparent" color="primary">\n    <ion-buttons left>\n      <button ion-button (click)="onDismiss()">\n        <span showWhen="ios,core">{{ \'CLOSE\' | translate }}</span>\n        <ion-icon name="md-close" showWhen="android,windows"></ion-icon>\n      </button>\n    </ion-buttons>\n    <ion-title>{{ \'FORGOT_PASSWORD\' | translate }}</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content text-center>\n\n  <p ion-text color="light">{{ \'FORGOT_PASSWORD_HELP\' | translate }}<p>\n\n<!--   <form [formGroup]="form" (ngSubmit)="onSubmit()" novalidate>\n\n    <ion-item class="transparent">\n      <ion-label stacked color="light">{{ \'EMAIL\' | translate }}</ion-label>\n      <ion-input type="email" formControlName="email"></ion-input>\n    </ion-item>\n\n\n    <div padding>\n      <button type="submit" round ion-button block color="light">\n        {{ \'SUBMIT\' | translate }}\n      </button>\n    </div>\n\n  </form> -->\n\n    <form [formGroup]="form" (ngSubmit)="finder()" novalidate>\n\n        <ion-item class="transparent">\n      <ion-label stacked color="light">{{ Phone Number | translate }}</ion-label>\n      <ion-input type="number" formControlName="username"></ion-input>\n    </ion-item>  \n    \n    <div padding>\n      <button type="submit" round ion-button block color="light">\n        {{ \'SUBMIT\' | translate }}\n      </button>\n    </div> \n      </form>      \n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/forgot-password/forgot-password.html"*/,
        }),
