...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobsListReviewPageModule", function() { return JobsListReviewPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jobslistreview_page__ = __webpack_require__(1188);
...
var JobsListReviewPageModule = (function () {
    function JobsListReviewPageModule() {
    }
    JobsListReviewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__jobslistreview_page__["a" /* JobsListReviewPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__jobslistreview_page__["a" /* JobsListReviewPage */]),
    ...
    ], JobsListReviewPageModule);
    return JobsListReviewPageModule;
}());

//# sourceMappingURL=jobslistreview-page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JobsListReviewPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_jobslistreview_service__ = __webpack_require__(650);
...
var JobsListReviewPage = (function (_super) {
    __extends(JobsListReviewPage, _super);
    function JobsListReviewPage(injector, jobslistreviewService) {
        var _this = _super.call(this, injector) || this;
        _this.jobslistreviewService = jobslistreviewService;
        _this.params = {};
        _this.params.jobslist = _this.navParams.data;
        return _this;
    }
    JobsListReviewPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    JobsListReviewPage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.onReload();
    };
    JobsListReviewPage.prototype.loadData = function () {
        var _this = this;
        this.jobslistreviewService.load(this.params).then(function (jobslistreviews) {
            for (var _i = 0, jobslistreviews_1 = jobslistreviews; _i < jobslistreviews_1.length; _i++) {
                var jobslistreview = jobslistreviews_1[_i];
                _this.jobslistreviews.push(jobslistreview);
            }
            _this.onRefreshComplete(jobslistreviews);
            if (_this.jobslistreviews.length) {
    ...
    JobsListReviewPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    JobsListReviewPage.prototype.onReload = function (refresher) {
