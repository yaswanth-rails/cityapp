...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateListDetailPageModule", function() { return UpdateListDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__updatelist_detail__ = __webpack_require__(1212);
...
var UpdateListDetailPageModule = (function () {
    function UpdateListDetailPageModule() {
    }
    UpdateListDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__updatelist_detail__["a" /* UpdateListDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__updatelist_detail__["a" /* UpdateListDetailPage */]),
    ...
    ], UpdateListDetailPageModule);
    return UpdateListDetailPageModule;
}());

//# sourceMappingURL=updatelist-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UpdateListDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_updatelist_service__ = __webpack_require__(647);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_updatelistreview_service__ = __webpack_require__(653);
...
var UpdateListDetailPage = (function (_super) {
    __extends(UpdateListDetailPage, _super);
    function UpdateListDetailPage(injector, renderer, platform, updatelistService, modalCtrl, preference, callNumber, geolocation, inAppBrowser, browserTab, reviewService, launchNavigator, socialSharing) {
        var _this = _super.call(this, injector) || this;
        _this.renderer = renderer;
        _this.platform = platform;
        _this.updatelistService = updatelistService;
        ...
        _this.updatelistreview = [];
        console.log("hi");
        _this.updatelist = _this.navParams.get('updatelist');
        console.log(_this.updatelist);
        _this.unit = _this.preference.unit;
        _this.images = [];
        if (_this.updatelist) {
            _this.rating = _this.updatelist.rating;
            _this.loadLocation();
            ...
            _this.loadReviews();
            if (_this.updatelist.image) {
                _this.images.push(_this.updatelist.image);
            }
            if (_this.updatelist.imageTwo) {
                _this.images.push(_this.updatelist.imageTwo);
            }
            if (_this.updatelist.imageThree) {
                _this.images.push(_this.updatelist.imageThree);
            }
            if (_this.updatelist.imageFour) {
                _this.images.push(_this.updatelist.imageFour);
            }
        }
        return _this;
    }
    UpdateListDetailPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    UpdateListDetailPage.prototype.ionViewDidLoad = function () {
    };
    UpdateListDetailPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    UpdateListDetailPage.prototype.checkIfIsLiked = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.updatelistService.isLiked(this.updatelist)];
                    case 1:
                        isLiked = _a.sent();
    ...
    UpdateListDetailPage.prototype.checkIfIsStarred = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isStarred, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.updatelistService.isStarred(this.updatelist)];
                    case 1:
                        isStarred = _a.sent();
    ...
    UpdateListDetailPage.prototype.loadLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UpdateListDetailPage.prototype.loadReviews = function () {
        return __awaiter(this, void 0, void 0, function () {
            var updatelistreview, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.reviewService.load({ updatelist: this.updatelist, limit: 5 })];
                    case 1:
                        updatelistreview = _a.sent();
    ...
    UpdateListDetailPage.prototype.openSignUpModal = function () {
        this.navigateTo('SignInPage');
    };
    UpdateListDetailPage.prototype.openAddReviewModal = function () {
        var modal = this.modalCtrl.create('AddUpdateListReviewPage', { updatelist: this.updatelist });
        modal.present();
    };
    UpdateListDetailPage.prototype.onLike = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
            this.isLiked = true;
    ...
    UpdateListDetailPage.prototype.onRate = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
    ...
    UpdateListDetailPage.prototype.onShare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.socialSharing.share(this.updatelist.title, null, null, this.updatelist.website)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    UpdateListDetailPage.prototype.onCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.updatelist.phone)
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.callNumber.callNumber(this.updatelist.phone, true)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    UpdateListDetailPage.prototype.openUrl = function () {
        var _this = this;
        if (!this.updatelist.website)
            return;
        if (this.platform.is('cordova')) {
            this.browserTab.isAvailable().then(function (isAvailable) {
                if (isAvailable) {
                    _this.browserTab.openUrl(_this.updatelist.website);
                }
                else {
                    _this.inAppBrowser.create(_this.updatelist.website, '_system');
                }
    ...
    UpdateListDetailPage.prototype.goToMap = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    UpdateListDetailPage.prototype.goToReviews = function () {
        this.navigateTo('UpdateListReviewPage', this.updatelist);
    };
    UpdateListDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-updatelist-detail',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/updatelist-detail/updatelist-detail.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>{{ updatelist.title }}</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="onShare()">\n        <ion-icon name="share"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <ion-slides pager>\n    <ion-slide *ngFor="let image of images">\n      <div class="img-container">\n        <img-loader [src]="image?.url()" (load)="onImageLoad($event)"></img-loader>\n      </div>\n    </ion-slide>\n  </ion-slides>\n\n  <div class="card-container">\n    <ion-fab right top>\n      <button ion-fab (click)="onLike()">\n        <ion-icon [name]="isLiked ? \'heart\' : \'heart-outline\'">{{updatelist.likeCount}}</ion-icon>\n      </button>\n    </ion-fab>\n    <ion-card class="shadow radius-top card-top" color="light">\n      <ion-card-content>\n\n        <p [class.hidden]="!location" margin-top float-end>\n          <ion-icon color="dark" name="pin"></ion-icon>\n          <span class="text-small bold" ion-text color="dark">\n            {{ updatelist.distance(location, unit) }}\n          </span>\n        </p>\n        <h2 class="bold" ion-text color="primary">{{ updatelist.title }}</h2>\n        <star-rating *ngIf="updatelist.rating" [starType]="\'svg\'" [size]="\'medium\'" [readOnly]="true" [showHalfStars]="false" [rating]="updatelist.rating">\n        </star-rating>\n        <p class="bold" margin-top ion-text color="dark">{{ updatelist.description }}</p>\n\n        <ion-row>\n          <ion-col col-4 text-center tapabble [class.disabled]="!updatelist.phone" (click)="onCall()">\n            <div>\n              <ion-icon name="call" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'CALL\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble (click)="goToMap()">\n            <div>\n              <ion-icon name="map" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'DIRECTIONS\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble [class.disabled]="!updatelist.website" (click)="openUrl()">\n            <div>\n              <ion-icon name="globe" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'WEBSITE\' | translate }}</p>\n          </ion-col>\n        </ion-row>\n\n      </ion-card-content>\n    </ion-card>\n  </div>\n\n  <section padding margin-top>\n\n    <ion-row align-items-center>\n      <ion-col col-8>\n        <h5 no-margin>\n          <ion-icon class="text-medium" name="chatbubbles" color="accent"></ion-icon>\n          {{ \'COMMENTS_AND_REACTIONS\' | translate }}\n        </h5>\n      </ion-col>\n      <ion-col col-4 text-end>\n        <button class="bold" ion-button small block round color="primary" (click)="onRate()">\n          {{ \'POST_REVIEW\' | translate }}\n        </button>\n      </ion-col>\n    </ion-row>\n\n    <div *ngIf="!updatelistreview.length" text-center>\n      <p class="text-medium" color="accent">\n        {{ \'EMPTY_REVIEWS\' | translate }}\n      </p>\n    </div>\n\n    <ion-list no-lines>\n      <div margin-bottom padding class="radius light-bg border" *ngFor="let updatelistreview of updatelistreview">\n        <ion-item no-padding color="light">\n          <ion-avatar item-start>\n            <img defaultImage="./assets/img/avatar.png"\n              [lazyLoad]="updatelistreview.user?.photo?.url()"\n              [scrollObservable]="container.ionScroll" />\n          </ion-avatar>\n          <h2 class="bold no-margin">{{ updatelistreview.user?.name }}</h2>\n          <p class="text-small no-margin" ion-text color="accent">\n            {{ updatelistreview.createdAt | date:\'mediumDate\' }}\n          </p>\n          <star-rating\n            [starType]="\'svg\'"\n            [size]="\'small\'"\n            [readOnly]="true"\n            [showHalfStars]="false"\n            [rating]="updatelistreview.rating">\n          </star-rating>\n        </ion-item>\n        <ion-row>\n          <ion-col no-padding col-12>\n            <p class="text-medium bold no-margin" ion-text color="dark">{{ updatelistreview.comment }}</p>\n          </ion-col>\n        </ion-row>\n      </div>\n    </ion-list>\n    <div text-center *ngIf="updatelistreview.length">\n      <button class="bold" ion-button icon-right clear color="dark" (click)="goToReviews()">\n        {{ \'VIEW_ALL_REVIEWS\' | translate }}\n        <ion-icon name="arrow-round-forward"></ion-icon>\n      </button>\n    </div>\n\n  </section>\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/updatelist-detail/updatelist-detail.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_updatelist_service__["a" /* UpdateList */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_updatelistreview_service__["a" /* UpdateListReview */],
    ...
    return UpdateListDetailPage;
}(__WEBPACK_IMPORTED_MODULE_10__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=updatelist-detail.js.map
