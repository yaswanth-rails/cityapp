...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateListPageModule", function() { return UpdateListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__updatelist__ = __webpack_require__(1214);
...
var UpdateListPageModule = (function () {
    function UpdateListPageModule() {
    }
    UpdateListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__updatelist__["a" /* UpdateListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__updatelist__["a" /* UpdateListPage */]),
    ...
    ], UpdateListPageModule);
    return UpdateListPageModule;
}());

//# sourceMappingURL=updatelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UpdateListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_updatelist_service__ = __webpack_require__(647);
...
var UpdateListPage = (function (_super) {
    __extends(UpdateListPage, _super);
    function UpdateListPage(injector, renderer, admobFree, popoverCtrl, updatelistService, preference) {
        ...
        _this.params = {};
        _this.updatelists = [];
        _this.params.cityupdate = _this.navParams.get('cityupdate');
    ...
    UpdateListPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    UpdateListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    UpdateListPage.prototype.prepareAd = function () {
    ...
    UpdateListPage.prototype.goToUpdateList = function (updatelist) {
        this.navigateTo('UpdateListDetailPage', { updatelist: updatelist });
    };
    UpdateListPage.prototype.openPopover = function (myEvent) {
    ...
    UpdateListPage.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var updatelists, _i, updatelists_1, updatelist, err_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.updatelistService.load(this.params)];
                    case 1:
                        updatelists = _a.sent();
                        for (_i = 0, updatelists_1 = updatelists; _i < updatelists_1.length; _i++) {
                            updatelist = updatelists_1[_i];
    ...
    UpdateListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    UpdateListPage.prototype.onReload = function (refresher) {
    ...
    UpdateListPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_updatelist_service__["a" /* UpdateList */],
