...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesRentPageModule", function() { return FavoritesRentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_rent__ = __webpack_require__(1175);
...
var FavoritesRentPageModule = (function () {
    function FavoritesRentPageModule() {
    }
    FavoritesRentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_rent__["a" /* FavoritesRentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_rent__["a" /* FavoritesRentPage */]),
    ...
    ], FavoritesRentPageModule);
    return FavoritesRentPageModule;
}());

//# sourceMappingURL=favorite-rent.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesRentPage; });
...
var FavoritesRentPage = (function (_super) {
    __extends(FavoritesRentPage, _super);
    function FavoritesRentPage(injector, renderer, popoverCtrl, rentlistService) {
    ...
    FavoritesRentPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesRentPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesRentPage.prototype.goToRentList = function (rentlist) {
        this.navigateTo('RentListDetailPage', { rentlist: rentlist });
    };
    FavoritesRentPage.prototype.openPopover = function (myEvent) {
    ...
    FavoritesRentPage.prototype.loadData = function () {
        var _this = this;
        this.rentlistService.loadFavorites(this.params).then(function (rentlists) {
            for (var _i = 0, rentlists_1 = rentlists; _i < rentlists_1.length; _i++) {
                var rentlist = rentlists_1[_i];
                _this.rentlists.push(rentlist);
            }
            _this.onRefreshComplete(rentlists);
            if (_this.rentlists.length) {
    ...
    FavoritesRentPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesRentPage.prototype.onReload = function (refresher) {
    ...
    return FavoritesRentPage;
}(__WEBPACK_IMPORTED_MODULE_3__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=favorite-rent.js.map
