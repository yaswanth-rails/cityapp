...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddJobsListPageModule", function() { return AddJobsListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_jobslist__ = __webpack_require__(1156);
...
var AddJobsListPageModule = (function () {
    function AddJobsListPageModule() {
    }
    AddJobsListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__add_jobslist__["a" /* AddJobsListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_jobslist__["a" /* AddJobsListPage */]),
    ...
    ], AddJobsListPageModule);
    return AddJobsListPageModule;
}());

//# sourceMappingURL=add-jobslist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddJobsListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_jobslist_service__ = __webpack_require__(643);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_jobs__ = __webpack_require__(656);
...
var AddJobsListPage = (function (_super) {
    __extends(AddJobsListPage, _super);
    function AddJobsListPage(injector, camera, geolocation, popoverCtrl, jobsService, actionSheetCtrl) {
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormGroup */]({
            ...
            jobs: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["g" /* Validators */].required),
    ...
    AddJobsListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    AddJobsListPage.prototype.ionViewDidLoad = function () {
    ...
    AddJobsListPage.prototype.openPopover = function (myEvent) {
    ...
    AddJobsListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.jobsService.load().then(function (jobs) {
            _this.jobs = jobs;
        }).catch(function (err) { return console.warn(err.message); });
    };
    AddJobsListPage.prototype.loadGoogleMaps = function () {
        var _this = this;
    ...
    AddJobsListPage.prototype.initMap = function () {
    ...
    AddJobsListPage.prototype.onSearchAddress = function (event) {
        var _this = this;
    ...
    AddJobsListPage.prototype.chooseImage = function (sourceType) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddJobsListPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddJobsListPage.prototype.prepareJobsListData = function () {
        var jobslist = new __WEBPACK_IMPORTED_MODULE_3__providers_jobslist_service__["a" /* JobsList */];
        jobslist.title = this.form.value.name;
        jobslist.jobs = this.form.value.jobs;
        jobslist.description = this.form.value.description;
        jobslist.address = this.form.value.address;
        jobslist.website = this.form.value.website;
        jobslist.phone = this.form.value.phone;
        jobslist.image = this.image;
        if (this.location) {
            var position = {
                lat: this.location.lat,
                lng: this.location.lng
            };
            jobslist.location = position;
        }
        return jobslist;
    };
    AddJobsListPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, trans, trans, jobslist, trans, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        _a.sent();
                        jobslist = this.prepareJobsListData();
                        return [4 /*yield*/, jobslist.save()];
                    case 8:
                        _a.sent();
                        this.form.reset();
