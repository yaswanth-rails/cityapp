...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jobs__ = __webpack_require__(1185);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_jobs__ = __webpack_require__(656);
...
var JobsPage = (function (_super) {
    ...
    function JobsPage(injector, events, renderer, jobsService, popoverCtrl) {
    ...
    JobsPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    ...
    JobsPage.prototype.goToJobsList = function (jobs) {
        this.navigateTo('JobsListPage', { jobs: jobs });
    };
    JobsPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    JobsPage.prototype.loadData = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.jobsService.load()];
                    case 1:
                        _a.jobs = _b.sent();
                        if (this.jobs.length) {
    ...
    JobsPage.prototype.openPopover = function (myEvent) {
    ...
    JobsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_jobs__["a" /* Jobs */],
