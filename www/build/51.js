...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesHomeServiceListPageModule", function() { return FavoritesHomeServiceListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_homeservice__ = __webpack_require__(1172);
...
var FavoritesHomeServiceListPageModule = (function () {
    function FavoritesHomeServiceListPageModule() {
    }
    FavoritesHomeServiceListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_homeservice__["a" /* FavoritesHomeServiceListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_homeservice__["a" /* FavoritesHomeServiceListPage */]),
    ...
    ], FavoritesHomeServiceListPageModule);
    return FavoritesHomeServiceListPageModule;
}());

//# sourceMappingURL=favorite-homeservice.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesHomeServiceListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__concion_popover_concion_popover__ = __webpack_require__(632);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_animations__ = __webpack_require__(255);
...
var FavoritesHomeServiceListPage = (function (_super) {
    __extends(FavoritesHomeServiceListPage, _super);
    function FavoritesHomeServiceListPage(injector, renderer, popoverCtrl, homeservicelistService) {
    ...
    FavoritesHomeServiceListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesHomeServiceListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesHomeServiceListPage.prototype.goToHomeServiceList = function (homeservicelist) {
        this.navigateTo('HomeServiceListDetailPage', { homeservicelist: homeservicelist });
    };
    FavoritesHomeServiceListPage.prototype.openPopover = function (myEvent) {
        //this.navctrl.setRoot(CancionPopoverPage,{event})
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_4__concion_popover_concion_popover__["a" /* CancionPopoverPage */]);
        popover.present({
            ev: myEvent
        });
    };
    FavoritesHomeServiceListPage.prototype.loadData = function () {
        var _this = this;
        this.homeservicelistService.loadFavorites(this.params).then(function (homeservicelists) {
            for (var _i = 0, homeservicelists_1 = homeservicelists; _i < homeservicelists_1.length; _i++) {
                var homeservicelist = homeservicelists_1[_i];
                _this.homeservicelists.push(homeservicelist);
            }
            _this.onRefreshComplete(homeservicelists);
            if (_this.homeservicelists.length) {
    ...
    FavoritesHomeServiceListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesHomeServiceListPage.prototype.onReload = function (refresher) {
    ...
    return FavoritesHomeServiceListPage;
}(__WEBPACK_IMPORTED_MODULE_3__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=favorite-homeservice.js.map
