...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__salelist__ = __webpack_require__(1204);
...
var SaleListPageModule = (function () {
    function SaleListPageModule() {
    }
    SaleListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__salelist__["a" /* SaleListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__salelist__["a" /* SaleListPage */]),
...
//# sourceMappingURL=salelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SaleListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_salelist_service__ = __webpack_require__(646);
...
var SaleListPage = (function (_super) {
    __extends(SaleListPage, _super);
    function SaleListPage(injector, renderer, admobFree, popoverCtrl, salelistService, preference) {
        ...
        _this.params = {};
        _this.salelists = [];
        _this.params.sale = _this.navParams.get('sale');
    ...
    SaleListPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    SaleListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    SaleListPage.prototype.prepareAd = function () {
    ...
    SaleListPage.prototype.openPopover = function (myEvent) {
    ...
    SaleListPage.prototype.goToSaleList = function (salelist) {
        this.navigateTo('SaleListDetailPage', { salelist: salelist });
    };
    SaleListPage.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var salelists, _i, salelists_1, salelist, err_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.salelistService.load(this.params)];
                    case 1:
                        salelists = _a.sent();
                        for (_i = 0, salelists_1 = salelists; _i < salelists_1.length; _i++) {
                            salelist = salelists_1[_i];
    ...
    SaleListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    SaleListPage.prototype.onReload = function (refresher) {
    ...
    SaleListPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_salelist_service__["a" /* SaleList */],
