...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpdateListReviewPageModule", function() { return UpdateListReviewPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__updatelistreview__ = __webpack_require__(1215);
...
var UpdateListReviewPageModule = (function () {
    function UpdateListReviewPageModule() {
    }
    UpdateListReviewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__updatelistreview__["a" /* UpdateListReviewPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__updatelistreview__["a" /* UpdateListReviewPage */]),
    ...
    ], UpdateListReviewPageModule);
    return UpdateListReviewPageModule;
}());

//# sourceMappingURL=updatelistreview.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UpdateListReviewPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_updatelistreview_service__ = __webpack_require__(653);
...
var UpdateListReviewPage = (function (_super) {
    __extends(UpdateListReviewPage, _super);
    function UpdateListReviewPage(injector, updatelistreviewService) {
        var _this = _super.call(this, injector) || this;
        _this.updatelistreviewService = updatelistreviewService;
        _this.params = {};
        _this.params.updatelist = _this.navParams.data;
        return _this;
    }
    UpdateListReviewPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    UpdateListReviewPage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.onReload();
    };
    UpdateListReviewPage.prototype.loadData = function () {
        var _this = this;
        this.updatelistreviewService.load(this.params).then(function (updatelistreviews) {
            for (var _i = 0, updatelistreviews_1 = updatelistreviews; _i < updatelistreviews_1.length; _i++) {
                var updatelistreview = updatelistreviews_1[_i];
                _this.updatelistreviews.push(updatelistreview);
            }
            _this.onRefreshComplete(updatelistreviews);
            if (_this.updatelistreviews.length) {
    ...
    UpdateListReviewPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    UpdateListReviewPage.prototype.onReload = function (refresher) {
