...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_item__ = __webpack_require__(1169);
...
var EditItemPageModule = (function () {
    ...
    EditItemPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__edit_item__["a" /* EditItemPage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_parse_file_service__ = __webpack_require__(633);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_categories__ = __webpack_require__(649);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_camera__ = __webpack_require__(634);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_sweetalert__ = __webpack_require__(1153);
...
var EditItemPage = (function (_super) {
    __extends(EditItemPage, _super);
    function EditItemPage(injector, camera, categoryService, actionSheetCtrl) {
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["b" /* FormGroup */]({
            name: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */](_this.place.title, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["g" /* Validators */].required),
            // category: new FormControl(this.place.category, Validators.required),
            description: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */](_this.place.description, __WEBPACK_IMPORTED_MODULE_5__angular_forms__["g" /* Validators */].required),
            address: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */](_this.place.address),
            phone: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */](_this.place.phone),
            website: new __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormControl */](_this.place.website),
        });
        return _this;
    }
    EditItemPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    ...
    EditItemPage.prototype.ionViewDidEnter = function () {
        var _this = this;
    ...
    //   });
    // }
    EditItemPage.prototype.chooseImage = function (sourceType) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        _b.sent();
                        _a = this;
                        return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_3__providers_parse_file_service__["a" /* ParseFile */].upload(imageData)];
                    case 3:
                        _a.image = _b.sent();
    ...
    EditItemPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    EditItemPage.prototype.preparePlaceData = function () {
    ...
    EditItemPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, place, trans, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 5:
                        trans = _a.sent();
                        __WEBPACK_IMPORTED_MODULE_7_sweetalert___default()(trans.GOOD_JOB, trans.PLACE_ADDED, 'success');
                        this.showContentView();
                        return [3 /*break*/, 7];
                    case 6:
                        err_1 = _a.sent();
