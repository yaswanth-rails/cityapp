...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__place_detail_page__ = __webpack_require__(1192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_review_service__ = __webpack_require__(645);
...
var PlaceDetailPage = (function (_super) {
    ...
    function PlaceDetailPage(injector, renderer, platform, placeService, modalCtrl, preference, callNumber, geolocation, inAppBrowser, browserTab, reviewService, launchNavigator, socialSharing) {
        ...
        _this.googleplace = _this.navParams.get('googleplace');
        console.log(_this.googleplace);
    ...
    PlaceDetailPage.prototype.GooglepalcesgoToMap = function () {
        return __awaiter(this, void 0, void 0, function () {
            var googleMaps, appleMaps, isGoogleMapsAvailable, isAppleMapsAvailable, app, options, destination, err_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
    ...
    PlaceDetailPage.prototype.goToGoogleReviews = function () {
