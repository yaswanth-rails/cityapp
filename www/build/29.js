...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RentListPageModule", function() { return RentListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__rentlist__ = __webpack_require__(1198);
...
var RentListPageModule = (function () {
    function RentListPageModule() {
    }
    RentListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__rentlist__["a" /* RentListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__rentlist__["a" /* RentListPage */]),
    ...
    return RentListPageModule;
}());

//# sourceMappingURL=rentlist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RentListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_rentlist_service__ = __webpack_require__(644);
...
var RentListPage = (function (_super) {
    __extends(RentListPage, _super);
    function RentListPage(injector, renderer, admobFree, popoverCtrl, rentlistService, preference) {
        ...
        _this.params = {};
        _this.rentlists = [];
        _this.params.rent = _this.navParams.get('rent');
    ...
    RentListPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    RentListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    RentListPage.prototype.prepareAd = function () {
    ...
    RentListPage.prototype.goToRentList = function (rentlist) {
        this.navigateTo('RentListDetailPage', { rentlist: rentlist });
    };
    RentListPage.prototype.openPopover = function (myEvent) {
    ...
    RentListPage.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rentlists, _i, rentlists_1, rentlist, err_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.rentlistService.load(this.params)];
                    case 1:
                        rentlists = _a.sent();
                        for (_i = 0, rentlists_1 = rentlists; _i < rentlists_1.length; _i++) {
                            rentlist = rentlists_1[_i];
    ...
    RentListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    RentListPage.prototype.onReload = function (refresher) {
    ...
    RentListPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_rentlist_service__["a" /* RentList */],
...
//# sourceMappingURL=rentlist.js.map
