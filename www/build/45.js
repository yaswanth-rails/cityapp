...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorites_page__ = __webpack_require__(1176);
...
var FavoritesPage = (function (_super) {
    ...
    function FavoritesPage(injector, renderer, popoverCtrl) {
    ...
    // }
    FavoritesPage.prototype.openPopover = function (myEvent) {
    ...
    FavoritesPage.prototype.gotoPlace = function () {
        this.navigateTo('FavoritesPlacePage');
    };
    FavoritesPage.prototype.gotoCityupdate = function () {
        this.navigateTo('FavoritesUpdatePage');
    };
    FavoritesPage.prototype.gotoSale = function () {
        this.navigateTo('FavoritesSale');
    };
    FavoritesPage.prototype.gotoRent = function () {
        this.navigateTo('FavoritesRentPage');
    };
    FavoritesPage.prototype.gotoJobs = function () {
        this.navigateTo('FavoritesJobsListPage');
    };
    FavoritesPage.prototype.gotoHomeServiceList = function () {
    ...
    FavoritesPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-favorites-page',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/favorites-page/favorites-page.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    \n     <ion-buttons end>\n     <a ion-button icon-only (click)="openPopover($event)">\n      <ion-icon name="md-happy"></ion-icon>\n    </a>\n    </ion-buttons>\n    <ion-title>{{ "MY_FAVORITES" | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n \n\n  <empty-view *ngIf="isErrorViewVisible" icon="alert" [text]="\'ERROR_NETWORK\' | translate">\n  </empty-view>\n\n  <empty-view *ngIf="isEmptyViewVisible" icon="heart" [text]="\'EMPTY_FAVORITES\' | translate">\n  </empty-view>\n\n\n<!-- <div (click)="gotoPlace()">\n<button>place </button></div>\n\n\n<div (click)="gotoCityupdate()">\n<button>CityUpate</button></div>\n\n<div (click)="gotoSale()">\n<button>Sale</button></div>\n<div (click)="gotoRent()">\n<button>Rent</button></div>\n<div (click)="gotoJobs()">\n<button>Jobs</button></div>\n<div (click)="gotoHomeServiceList()">\n<button>HomeService</button></div> -->\n\n\n  <ion-grid>\n    <ion-row>\n\n      <ion-col>\n           <ion-avatar item-left (click)="gotoPlace()">\n        <p class="saletext"> Add Place List </p>\n        </ion-avatar>\n       </ion-col>\n       <ion-col>\n         <ion-avatar item-left (click)="gotoCityupdate()">\n         <p class="saletext">CityUpate</p>\n        </ion-avatar>\n      </ion-col>\n       </ion-row>\n      </ion-grid>\n\n\n\n  <ion-grid>\n    <ion-row>\n\n      <ion-col>\n           <ion-avatar item-left (click)="gotoSale()">\n        <p class="saletext">Sale</p>\n        </ion-avatar>\n       </ion-col>\n       <ion-col>\n         <ion-avatar item-left (click)="gotoRent()">\n         <p class="saletext">Rent</p>\n        </ion-avatar>\n      </ion-col>\n       </ion-row>\n      </ion-grid>\n\n\n  <ion-grid>\n    <ion-row>\n\n      <ion-col>\n           <ion-avatar item-left (click)="gotoJobs()">\n        <p class="saletext"> Jobs </p>\n        </ion-avatar>\n       </ion-col>\n       <ion-col>\n         <ion-avatar item-left (click)="gotoHomeServiceList()">\n         <p class="saletext">Home Service</p>\n        </ion-avatar>\n      </ion-col>\n       </ion-row>\n      </ion-grid>\n\n<!--   <div [@staggerIn]="places.length">\n    <ion-card class="shadow" no-margin margin-bottom color="light" *ngFor="let place of places" (click)="goToPlace(place)">\n      <div class="card-img">\n        <img-loader [src]="place.image?.url()" (load)="onImageLoad($event)"></img-loader>\n      </div>\n      <ion-card-content>\n        <ion-row no-padding>\n          <ion-col col-8>\n            <p class="bold">{{ place.title }}</p>\n            <star-rating *ngIf="place.rating"\n              [starType]="\'svg\'"\n              [size]="\'medium\'"\n              [readOnly]="true"\n              [showHalfStars]="false"\n              [rating]="place.rating">\n            </star-rating>\n            <span class="bold text-small" ion-text color="accent">{{ place.category?.title }}</span>\n          </ion-col>\n          <ion-col col-4 text-end align-self-end>\n            <span class="bold text-small" ion-text color="primary">\n              {{ place.distance(params.location, params.unit) }}\n            </span>\n          </ion-col>\n        </ion-row>\n      </ion-card-content>\n    </ion-card>\n  </div> -->\n\n  <ion-infinite-scroll (ionInfinite)="onLoadMore($event)">\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/favorites-page/favorites-page.html"*/,
            animations: [
