...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SaleListDetailPageModule", function() { return SaleListDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__salelist_detail_page__ = __webpack_require__(1203);
...
var SaleListDetailPageModule = (function () {
    function SaleListDetailPageModule() {
    }
    SaleListDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__salelist_detail_page__["a" /* SaleListDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__salelist_detail_page__["a" /* SaleListDetailPage */]),
    ...
    ], SaleListDetailPageModule);
    return SaleListDetailPageModule;
}());

//# sourceMappingURL=salelist-detail-page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SaleListDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_salelist_service__ = __webpack_require__(646);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_salelistreview_service__ = __webpack_require__(651);
...
var SaleListDetailPage = (function (_super) {
    __extends(SaleListDetailPage, _super);
    function SaleListDetailPage(injector, renderer, platform, salelistService, modalCtrl, preference, callNumber, geolocation, inAppBrowser, browserTab, reviewService, launchNavigator, socialSharing) {
        var _this = _super.call(this, injector) || this;
        _this.renderer = renderer;
        _this.platform = platform;
        _this.salelistService = salelistService;
        ...
        _this.salelistreview = [];
        console.log("hi");
        _this.salelist = _this.navParams.get('salelist');
        console.log(_this.salelist);
        _this.unit = _this.preference.unit;
        _this.images = [];
        if (_this.salelist) {
            _this.rating = _this.salelist.rating;
            _this.loadLocation();
            ...
            _this.loadReviews();
            if (_this.salelist.image) {
                _this.images.push(_this.salelist.image);
            }
            if (_this.salelist.imageTwo) {
                _this.images.push(_this.salelist.imageTwo);
            }
            if (_this.salelist.imageThree) {
                _this.images.push(_this.salelist.imageThree);
            }
            if (_this.salelist.imageFour) {
                _this.images.push(_this.salelist.imageFour);
            }
        }
        return _this;
    }
    SaleListDetailPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    SaleListDetailPage.prototype.ionViewDidLoad = function () {
    };
    SaleListDetailPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    SaleListDetailPage.prototype.checkIfIsLiked = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salelistService.isLiked(this.salelist)];
                    case 1:
                        isLiked = _a.sent();
    ...
    SaleListDetailPage.prototype.checkIfIsStarred = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isStarred, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salelistService.isStarred(this.salelist)];
                    case 1:
                        isStarred = _a.sent();
    ...
    SaleListDetailPage.prototype.loadLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SaleListDetailPage.prototype.loadReviews = function () {
        return __awaiter(this, void 0, void 0, function () {
            var salelistreview, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.reviewService.load({ salelist: this.salelist, limit: 5 })];
                    case 1:
                        salelistreview = _a.sent();
    ...
    SaleListDetailPage.prototype.openSignUpModal = function () {
        this.navigateTo('SignInPage');
    };
    SaleListDetailPage.prototype.openAddReviewModal = function () {
        var modal = this.modalCtrl.create('AddSaleListReviewPage', { salelist: this.salelist });
        modal.present();
    };
    SaleListDetailPage.prototype.onLike = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
            this.isLiked = true;
    ...
    SaleListDetailPage.prototype.onRate = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
    ...
    SaleListDetailPage.prototype.onShare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.socialSharing.share(this.salelist.title, null, null, this.salelist.website)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    SaleListDetailPage.prototype.onCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.salelist.phone)
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.callNumber.callNumber(this.salelist.phone, true)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    SaleListDetailPage.prototype.openUrl = function () {
        var _this = this;
        if (!this.salelist.website)
            return;
        if (this.platform.is('cordova')) {
            this.browserTab.isAvailable().then(function (isAvailable) {
                if (isAvailable) {
                    _this.browserTab.openUrl(_this.salelist.website);
                }
                else {
                    _this.inAppBrowser.create(_this.salelist.website, '_system');
                }
    ...
    SaleListDetailPage.prototype.goToMap = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    SaleListDetailPage.prototype.goToReviews = function () {
        this.navigateTo('SaleListReviewPage', this.salelist);
    };
    SaleListDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-salelist-detail-page',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/salelist-detail-page/salelist-detail-page.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>{{ salelist.title }}</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="onShare()">\n        <ion-icon name="share"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <ion-slides pager>\n    <ion-slide *ngFor="let image of images">\n      <div class="img-container">\n        <img-loader [src]="image?.url()" (load)="onImageLoad($event)"></img-loader>\n      </div>\n    </ion-slide>\n  </ion-slides>\n\n  <div class="card-container">\n    <ion-fab right top>\n      <button ion-fab (click)="onLike()">\n        <ion-icon [name]="isLiked ? \'heart\' : \'heart-outline\'">{{salelist.likeCount}}</ion-icon>\n      </button>\n    </ion-fab>\n    <ion-card class="shadow radius-top card-top" color="light">\n      <ion-card-content>\n\n        <p [class.hidden]="!location" margin-top float-end>\n          <ion-icon color="dark" name="pin"></ion-icon>\n          <span class="text-small bold" ion-text color="dark">\n            {{ salelist.distance(location, unit) }}\n          </span>\n        </p>\n        <h2 class="bold" ion-text color="primary">{{ salelist.title }}</h2>\n        <star-rating *ngIf="salelist.rating" [starType]="\'svg\'" [size]="\'medium\'" [readOnly]="true" [showHalfStars]="false" [rating]="salelist.rating">\n        </star-rating>\n        <p class="bold" margin-top ion-text color="dark">{{ salelist.description }}</p>\n\n        <ion-row>\n          <ion-col col-4 text-center tapabble [class.disabled]="!salelist.phone" (click)="onCall()">\n            <div>\n              <ion-icon name="call" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'CALL\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble (click)="goToMap()">\n            <div>\n              <ion-icon name="map" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'DIRECTIONS\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble [class.disabled]="!salelist.website" (click)="openUrl()">\n            <div>\n              <ion-icon name="globe" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'WEBSITE\' | translate }}</p>\n          </ion-col>\n        </ion-row>\n\n      </ion-card-content>\n    </ion-card>\n  </div>\n\n  <section padding margin-top>\n\n    <ion-row align-items-center>\n      <ion-col col-8>\n        <h5 no-margin>\n          <ion-icon class="text-medium" name="chatbubbles" color="accent"></ion-icon>\n          {{ \'COMMENTS_AND_REACTIONS\' | translate }}\n        </h5>\n      </ion-col>\n      <ion-col col-4 text-end>\n        <button class="bold" ion-button small block round color="primary" (click)="onRate()">\n          {{ \'POST_REVIEW\' | translate }}\n        </button>\n      </ion-col>\n    </ion-row>\n\n    <div *ngIf="!salelistreview.length" text-center>\n      <p class="text-medium" color="accent">\n        {{ \'EMPTY_REVIEWS\' | translate }}\n      </p>\n    </div>\n\n    <ion-list no-lines>\n      <div margin-bottom padding class="radius light-bg border" *ngFor="let salelistreview of salelistreview">\n        <ion-item no-padding color="light">\n          <ion-avatar item-start>\n            <img defaultImage="./assets/img/avatar.png"\n              [lazyLoad]="salelistreview.user?.photo?.url()"\n              [scrollObservable]="container.ionScroll" />\n          </ion-avatar>\n          <h2 class="bold no-margin">{{ salelistreview.user?.name }}</h2>\n          <p class="text-small no-margin" ion-text color="accent">\n            {{ salelistreview.createdAt | date:\'mediumDate\' }}\n          </p>\n          <star-rating\n            [starType]="\'svg\'"\n            [size]="\'small\'"\n            [readOnly]="true"\n            [showHalfStars]="false"\n            [rating]="salelistreview.rating">\n          </star-rating>\n        </ion-item>\n        <ion-row>\n          <ion-col no-padding col-12>\n            <p class="text-medium bold no-margin" ion-text color="dark">{{ salelistreview.comment }}</p>\n          </ion-col>\n        </ion-row>\n      </div>\n    </ion-list>\n    <div text-center *ngIf="salelistreview.length">\n      <button class="bold" ion-button icon-right clear color="dark" (click)="goToReviews()">\n        {{ \'VIEW_ALL_REVIEWS\' | translate }}\n        <ion-icon name="arrow-round-forward"></ion-icon>\n      </button>\n    </div>\n\n  </section>\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/salelist-detail-page/salelist-detail-page.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_salelist_service__["a" /* SaleList */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_salelistreview_service__["a" /* SaleListReview */],
    ...
    return SaleListDetailPage;
}(__WEBPACK_IMPORTED_MODULE_10__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=salelist-detail-page.js.map
