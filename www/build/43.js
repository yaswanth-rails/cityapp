...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__homeservice__ = __webpack_require__(1181);
...
var HomeServicePageModule = (function () {
    ...
    HomeServicePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__homeservice__["a" /* HomeServicePage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__homeservice__["a" /* HomeServicePage */]),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_homeservice__ = __webpack_require__(655);
...
var HomeServicePage = (function (_super) {
    __extends(HomeServicePage, _super);
    function HomeServicePage(injector, events, renderer, homeserviceService, popoverCtrl) {
    ...
    HomeServicePage.prototype.enableMenuSwipe = function () {
        return true;
    };
    HomeServicePage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.loadData();
    };
    HomeServicePage.prototype.goToHomeServiceList = function (homeservice) {
        this.navigateTo('HomeServiceListPage', { homeservice: homeservice });
    };
    HomeServicePage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    HomeServicePage.prototype.loadData = function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.homeserviceService.load()];
                    case 1:
                        _a.homeservice = _b.sent();
    ...
    HomeServicePage.prototype.openPopover = function (myEvent) {
    ...
    HomeServicePage.prototype.onReload = function (refresher) {
        this.refresher = refresher;
        this.loadData();
    };
    HomeServicePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-homeservice',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/homeservice/homeservice.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    \n     <ion-buttons end>\n     <a ion-button icon-only (click)="openPopover($event)">\n      <ion-icon name="md-happy"></ion-icon>\n    </a>\n    </ion-buttons>\n    <ion-title>{{ \'HOMESERVICE\' | translate }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <empty-view *ngIf="isErrorViewVisible" icon="alert"\n    [text]="\'ERROR_NETWORK\' | translate">\n  </empty-view>\n\n  <empty-view *ngIf="isEmptyViewVisible" icon="bookmark"\n    [text]="\'EMPTY_CATEGORIES\' | translate">\n  </empty-view>\n\n  <ion-refresher (ionRefresh)="onReload($event)">\n    <ion-refresher-content\n      pullingText="{{ \'PULL_TO_REFRESH\' | translate }}"\n      refreshingText="{{ \'REFRESHING\' | translate }}">\n    </ion-refresher-content>\n  </ion-refresher>\n\n  <!-- <div [@staggerIn]="homeservice.length">\n    <div class="card-img" *ngFor="let homeservice of homeservice" (click)="goToHomeServiceList(homeservice)">\n      <img-loader [src]="homeservice.image.url()" (load)="onImageLoad($event)"></img-loader>\n      <div>\n        <h5 class="bold" ion-text color="light">{{ homeservice.title }}</h5>\n        <span class="gradient-bg bold" ion-text color="light">\n          {{ homeservice.homeservicelistCount }} {{ \'PLACES\' | translate }}\n        </span>\n      </div>\n    </div>\n  </div> -->\n    <ion-list *ngIf="isContentViewVisible">\n    <ion-item *ngFor="let homeservice of homeservice" (click)="goToHomeServiceList(homeservice)">\n      <ion-avatar item-left>\n        <img src="assets/img/tag.png" offset="100"\n          [lazyLoad]="homeservice.imageThumb.url()"\n          [scrollTarget]="container.getScrollElement()">\n      </ion-avatar>\n      <h2>{{ homeservice.title }}</h2>\n    </ion-item>\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/homeservice/homeservice.html"*/,
            animations: [
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_homeservice__["a" /* HomeService */],
