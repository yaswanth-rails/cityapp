...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeServiceListPageModule", function() { return HomeServiceListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__homeservicelist__ = __webpack_require__(1183);
...
var HomeServiceListPageModule = (function () {
    function HomeServiceListPageModule() {
    }
    HomeServiceListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__homeservicelist__["a" /* HomeServiceListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__homeservicelist__["a" /* HomeServiceListPage */]),
    ...
    ], HomeServiceListPageModule);
    return HomeServiceListPageModule;
}());

//# sourceMappingURL=homeservicelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HomeServiceListPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_app_config__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_homeservicelist_service__ = __webpack_require__(642);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_preference__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_admob_free__ = __webpack_require__(641);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__concion_popover_concion_popover__ = __webpack_require__(632);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_animations__ = __webpack_require__(255);
...
var HomeServiceListPage = (function (_super) {
    __extends(HomeServiceListPage, _super);
    function HomeServiceListPage(injector, renderer, admobFree, popoverCtrl, homeservicelistService, preference) {
        ...
        _this.params = {};
        _this.homeservicelists = [];
        _this.params.homeservice = _this.navParams.get('homeservice');
    ...
    HomeServiceListPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    HomeServiceListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    HomeServiceListPage.prototype.prepareAd = function () {
    ...
    HomeServiceListPage.prototype.goToHomeServiceList = function (homeservicelist) {
        this.navigateTo('HomeServiceListDetailPage', { homeservicelist: homeservicelist });
    };
    HomeServiceListPage.prototype.openPopover = function (myEvent) {
        //this.navctrl.setRoot(CancionPopoverPage,{event})
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_7__concion_popover_concion_popover__["a" /* CancionPopoverPage */]);
        popover.present({
            ev: myEvent
        });
    };
    HomeServiceListPage.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var homeservicelists, _i, homeservicelists_1, homeservicelist, err_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.homeservicelistService.load(this.params)];
                    case 1:
                        homeservicelists = _a.sent();
                        for (_i = 0, homeservicelists_1 = homeservicelists; _i < homeservicelists_1.length; _i++) {
                            homeservicelist = homeservicelists_1[_i];
    ...
    HomeServiceListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    HomeServiceListPage.prototype.onReload = function (refresher) {
    ...
    HomeServiceListPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_homeservicelist_service__["a" /* HomeServiceList */],
            __WEBPACK_IMPORTED_MODULE_5__providers_preference__["a" /* Preference */]])
    ], HomeServiceListPage);
    return HomeServiceListPage;
}(__WEBPACK_IMPORTED_MODULE_2__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=homeservicelist.js.map
