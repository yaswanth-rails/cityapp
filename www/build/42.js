...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeServiceListDetailPageModule", function() { return HomeServiceListDetailPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__homeservicelist_detail__ = __webpack_require__(1182);
...
var HomeServiceListDetailPageModule = (function () {
    function HomeServiceListDetailPageModule() {
    }
    HomeServiceListDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__homeservicelist_detail__["a" /* HomeServiceListDetailPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__homeservicelist_detail__["a" /* HomeServiceListDetailPage */]),
    ...
    ], HomeServiceListDetailPageModule);
    return HomeServiceListDetailPageModule;
}());

//# sourceMappingURL=homeservicelist-detail.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HomeServiceListDetailPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_homeservicelist_service__ = __webpack_require__(642);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_homeservicelistreview_service__ = __webpack_require__(648);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__concion_popover_concion_popover__ = __webpack_require__(632);
...
var HomeServiceListDetailPage = (function (_super) {
    __extends(HomeServiceListDetailPage, _super);
    function HomeServiceListDetailPage(injector, renderer, platform, homeservicelistService, modalCtrl, preference, callNumber, geolocation, inAppBrowser, browserTab, reviewService, launchNavigator, socialSharing, popoverCtrl) {
        var _this = _super.call(this, injector) || this;
        _this.renderer = renderer;
        _this.platform = platform;
        _this.homeservicelistService = homeservicelistService;
        ...
        _this.homeservicelistreview = [];
        _this.homeservicelist = _this.navParams.get('homeservicelist');
        console.log(_this.homeservicelist);
        _this.unit = _this.preference.unit;
        _this.images = [];
        if (_this.homeservicelist) {
            _this.rating = _this.homeservicelist.rating;
            _this.loadLocation();
            ...
            _this.loadReviews();
            if (_this.homeservicelist.image) {
                _this.images.push(_this.homeservicelist.image);
            }
            if (_this.homeservicelist.imageTwo) {
                _this.images.push(_this.homeservicelist.imageTwo);
            }
            if (_this.homeservicelist.imageThree) {
                _this.images.push(_this.homeservicelist.imageThree);
            }
            if (_this.homeservicelist.imageFour) {
                _this.images.push(_this.homeservicelist.imageFour);
            }
        }
        return _this;
    }
    HomeServiceListDetailPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    HomeServiceListDetailPage.prototype.ionViewDidLoad = function () {
    };
    HomeServiceListDetailPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    HomeServiceListDetailPage.prototype.checkIfIsLiked = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.homeservicelistService.isLiked(this.homeservicelist)];
                    case 1:
                        isLiked = _a.sent();
    ...
    HomeServiceListDetailPage.prototype.checkIfIsStarred = function () {
        return __awaiter(this, void 0, void 0, function () {
            var isStarred, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.homeservicelistService.isStarred(this.homeservicelist)];
                    case 1:
                        isStarred = _a.sent();
    ...
    HomeServiceListDetailPage.prototype.loadLocation = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    HomeServiceListDetailPage.prototype.loadReviews = function () {
        return __awaiter(this, void 0, void 0, function () {
            var homeservicelistreview, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.reviewService.load({ homeservicelist: this.homeservicelist, limit: 5 })];
                    case 1:
                        homeservicelistreview = _a.sent();
    ...
    HomeServiceListDetailPage.prototype.openPopover = function (myEvent) {
        //this.navctrl.setRoot(CancionPopoverPage,{event})
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_13__concion_popover_concion_popover__["a" /* CancionPopoverPage */]);
        popover.present({
            ev: myEvent
        });
    };
    HomeServiceListDetailPage.prototype.openSignUpModal = function () {
        this.navigateTo('SignInPage');
    };
    HomeServiceListDetailPage.prototype.openAddReviewModal = function () {
        var modal = this.modalCtrl.create('AddHomeServiceListReviewPage', { homeservicelist: this.homeservicelist });
        modal.present();
    };
    HomeServiceListDetailPage.prototype.onLike = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
            this.isLiked = true;
    ...
    HomeServiceListDetailPage.prototype.onRate = function () {
        if (__WEBPACK_IMPORTED_MODULE_11__providers_user_service__["a" /* User */].getCurrentUser()) {
    ...
    HomeServiceListDetailPage.prototype.onShare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.socialSharing.share(this.homeservicelist.title, null, null, this.homeservicelist.website)];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    HomeServiceListDetailPage.prototype.onCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.homeservicelist.phone)
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.callNumber.callNumber(this.homeservicelist.phone, true)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
    ...
    HomeServiceListDetailPage.prototype.openUrl = function () {
        var _this = this;
        if (!this.homeservicelist.website)
            return;
        if (this.platform.is('cordova')) {
            this.browserTab.isAvailable().then(function (isAvailable) {
                if (isAvailable) {
                    _this.browserTab.openUrl(_this.homeservicelist.website);
                }
                else {
                    _this.inAppBrowser.create(_this.homeservicelist.website, '_system');
                }
    ...
    HomeServiceListDetailPage.prototype.goToMap = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    HomeServiceListDetailPage.prototype.goToReviews = function () {
        this.navigateTo('HomeServiceListReviewPage', this.homeservicelist);
    };
    HomeServiceListDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["Component"])({
            selector: 'page-homeservicelist-detail-page',template:/*ion-inline-start:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/homeservicelist-detail/homeservicelist-detail.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>{{ homeservicelist.title }}</ion-title>\n    <ion-buttons end>\n      <button ion-button icon-only (click)="onShare()">\n        <ion-icon name="share"></ion-icon>\n      </button>\n<!--        <ion-buttons>\n     <a ion-button icon-only (click)="openPopover($event)">\n      <ion-icon name="md-happy"></ion-icon>\n    </a>\n    </ion-buttons> -->\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content #container>\n\n  <ion-slides pager>\n    <ion-slide *ngFor="let image of images">\n      <div class="img-container">\n        <img-loader [src]="image?.url()" (load)="onImageLoad($event)">{{homeservicelist.likeCount}}</img-loader>\n      </div>\n    </ion-slide>\n  </ion-slides>\n\n  <div class="card-container">\n    <ion-fab right top>\n      <button ion-fab (click)="onLike()">\n        <ion-icon [name]="isLiked ? \'heart\' : \'heart-outline\'"></ion-icon>\n      </button>\n    </ion-fab>\n    <ion-card class="shadow radius-top card-top" color="light">\n      <ion-card-content>\n\n        <p [class.hidden]="!location" margin-top float-end>\n          <ion-icon color="dark" name="pin"></ion-icon>\n          <span class="text-small bold" ion-text color="dark">\n            {{ homeservicelist.distance(location, unit) }}\n          </span>\n        </p>\n        <h2 class="bold" ion-text color="primary">{{ homeservicelist.title }}</h2>\n        <star-rating *ngIf="homeservicelist.rating" [starType]="\'svg\'" [size]="\'medium\'" [readOnly]="true" [showHalfStars]="false" [rating]="homeservicelist.rating">\n        </star-rating>\n        <p class="bold" margin-top ion-text color="dark">{{ homeservicelist.description }}</p>\n\n        <ion-row>\n          <ion-col col-4 text-center tapabble [class.disabled]="!homeservicelist.phone" (click)="onCall()">\n            <div>\n              <ion-icon name="call" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'CALL\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble (click)="goToMap()">\n            <div>\n              <ion-icon name="map" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'DIRECTIONS\' | translate }}</p>\n          </ion-col>\n          <ion-col col-4 text-center tapabble [class.disabled]="!homeservicelist.website" (click)="openUrl()">\n            <div>\n              <ion-icon name="globe" color="primary"></ion-icon>\n            </div>\n            <p class="bold" ion-text color="primary">{{ \'WEBSITE\' | translate }}</p>\n          </ion-col>\n        </ion-row>\n\n      </ion-card-content>\n    </ion-card>\n  </div>\n\n  <section padding margin-top>\n\n    <ion-row align-items-center>\n      <ion-col col-8>\n        <h5 no-margin>\n          <ion-icon class="text-medium" name="chatbubbles" color="accent"></ion-icon>\n          {{ \'COMMENTS_AND_REACTIONS\' | translate }}\n        </h5>\n      </ion-col>\n      <ion-col col-4 text-end>\n        <button class="bold" ion-button small block round color="primary" (click)="onRate()">\n          {{ \'POST_REVIEW\' | translate }}\n        </button>\n      </ion-col>\n    </ion-row>\n\n    <div *ngIf="!homeservicelistreview.length" text-center>\n      <p class="text-medium" color="accent">\n        {{ \'EMPTY_REVIEWS\' | translate }}\n      </p>\n    </div>\n\n    <ion-list no-lines>\n      <div margin-bottom padding class="radius light-bg border" *ngFor="let homeservicelistreview of homeservicelistreview">\n        <ion-item no-padding color="light">\n          <ion-avatar item-start>\n            <img defaultImage="./assets/img/avatar.png"\n              [lazyLoad]="homeservicelistreview.user?.photo?.url()"\n              [scrollObservable]="container.ionScroll" />\n          </ion-avatar>\n          <h2 class="bold no-margin">{{ homeservicelistreview.user?.name }}</h2>\n          <p class="text-small no-margin" ion-text color="accent">\n            {{ homeservicelistreview.createdAt | date:\'mediumDate\' }}\n          </p>\n          <star-rating\n            [starType]="\'svg\'"\n            [size]="\'small\'"\n            [readOnly]="true"\n            [showHalfStars]="false"\n            [rating]="homeservicelistreview.rating">\n          </star-rating>\n        </ion-item>\n        <ion-row>\n          <ion-col no-padding col-12>\n            <p class="text-medium bold no-margin" ion-text color="dark">{{ homeservicelistreview.comment }}</p>\n          </ion-col>\n        </ion-row>\n      </div>\n    </ion-list>\n    <div text-center *ngIf="homeservicelistreview.length">\n      <button class="bold" ion-button icon-right clear color="dark" (click)="goToReviews()">\n        {{ \'VIEW_ALL_REVIEWS\' | translate }}\n        <ion-icon name="arrow-round-forward"></ion-icon>\n      </button>\n    </div>\n\n  </section>\n\n</ion-content>\n'/*ion-inline-end:"/Users/Nagu/Desktop/Backup--nearme/22-09-2018/NearmeApp/src/pages/homeservicelist-detail/homeservicelist-detail.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_2__providers_homeservicelist_service__["a" /* HomeServiceList */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__providers_homeservicelistreview_service__["a" /* HomeServiceListReview */],
    ...
    return HomeServiceListDetailPage;
}(__WEBPACK_IMPORTED_MODULE_10__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=homeservicelist-detail.js.map
