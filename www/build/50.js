...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FavoritesJobsListPageModule", function() { return FavoritesJobsListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__favorite_jobs__ = __webpack_require__(1171);
...
var FavoritesJobsListPageModule = (function () {
    function FavoritesJobsListPageModule() {
    }
    FavoritesJobsListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__favorite_jobs__["a" /* FavoritesJobsListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__favorite_jobs__["a" /* FavoritesJobsListPage */]),
    ...
    ], FavoritesJobsListPageModule);
    return FavoritesJobsListPageModule;
}());

//# sourceMappingURL=favorite-jobs.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FavoritesJobsListPage; });
...
var FavoritesJobsListPage = (function (_super) {
    __extends(FavoritesJobsListPage, _super);
    function FavoritesJobsListPage(injector, renderer, popoverCtrl, jobslistService) {
    ...
    FavoritesJobsListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    FavoritesJobsListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    FavoritesJobsListPage.prototype.goToJobsList = function (jobslist) {
        this.navigateTo('JobsListDetailPage', { jobslist: jobslist });
    };
    FavoritesJobsListPage.prototype.openPopover = function (myEvent) {
    ...
    FavoritesJobsListPage.prototype.loadData = function () {
        var _this = this;
        this.jobslistService.loadFavorites(this.params).then(function (jobslists) {
            for (var _i = 0, jobslists_1 = jobslists; _i < jobslists_1.length; _i++) {
                var jobslist = jobslists_1[_i];
                _this.jobslists.push(jobslist);
            }
            _this.onRefreshComplete(jobslists);
            if (_this.jobslists.length) {
    ...
    FavoritesJobsListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    FavoritesJobsListPage.prototype.onReload = function (refresher) {
    ...
    return FavoritesJobsListPage;
}(__WEBPACK_IMPORTED_MODULE_3__base_page_base_page__["a" /* BasePage */]));

//# sourceMappingURL=favorite-jobs.js.map
