...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HomeServiceListReviewPageModule", function() { return HomeServiceListReviewPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__homeservicelistreview__ = __webpack_require__(1184);
...
var HomeServiceListReviewPageModule = (function () {
    function HomeServiceListReviewPageModule() {
    }
    HomeServiceListReviewPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__homeservicelistreview__["a" /* HomeServiceListReviewPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__homeservicelistreview__["a" /* HomeServiceListReviewPage */]),
    ...
    ], HomeServiceListReviewPageModule);
    return HomeServiceListReviewPageModule;
}());

//# sourceMappingURL=homeservicelistreview.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HomeServiceListReviewPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_homeservicelistreview_service__ = __webpack_require__(648);
...
var HomeServiceListReviewPage = (function (_super) {
    __extends(HomeServiceListReviewPage, _super);
    function HomeServiceListReviewPage(injector, homeservicelistreviewService) {
        var _this = _super.call(this, injector) || this;
        _this.homeservicelistreviewService = homeservicelistreviewService;
        _this.params = {};
        _this.params.homeservicelist = _this.navParams.data;
        return _this;
    }
    HomeServiceListReviewPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    HomeServiceListReviewPage.prototype.ionViewDidLoad = function () {
        this.showLoadingView();
        this.onReload();
    };
    HomeServiceListReviewPage.prototype.loadData = function () {
        var _this = this;
        this.homeservicelistreviewService.load(this.params).then(function (homeservicelistreviews) {
            for (var _i = 0, homeservicelistreviews_1 = homeservicelistreviews; _i < homeservicelistreviews_1.length; _i++) {
                var homeservicelistreview = homeservicelistreviews_1[_i];
                _this.homeservicelistreviews.push(homeservicelistreview);
            }
            _this.onRefreshComplete(homeservicelistreviews);
            if (_this.homeservicelistreviews.length) {
    ...
    HomeServiceListReviewPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    HomeServiceListReviewPage.prototype.onReload = function (refresher) {
