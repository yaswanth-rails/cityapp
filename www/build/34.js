...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__places__ = __webpack_require__(1193);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_place_service__ = __webpack_require__(254);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_add_operator_map__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10_rxjs_add_operator_map__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_locations__ = __webpack_require__(654);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_animations__ = __webpack_require__(255);
...
var PlacesPage = (function (_super) {
    ...
    function PlacesPage(injector, popoverCtrl, http, renderer, admobFree, placeService, platform, location, maps, preference) {
        ...
        _this.places = [];
        _this.googleplaces = [];
        _this.apikey = 'AIzaSyBrmUANBWFGdVahMgTiVnfGucKyi5iRiwA';
        _this.url = [];
        _this.merged = [];
        _this.params.category = _this.navParams.get('category');
        console.log(_this.params.category);
    ...
    PlacesPage.prototype.ionViewDidLoad = function () {
        ...
        if (this.params.category.title != 'Theatres' && this.params.category.title != 'MobileService') {
            this.platform.ready().then(function () {
                _this.maps.init(_this.mapElement.nativeElement);
            });
            this.initMap();
        }
    };
    ...
    PlacesPage.prototype.openPopover = function (myEvent) {
    ...
    PlacesPage.prototype.goToGooglePlace = function (googleplace) {
    ...
    PlacesPage.prototype.initMap = function () {
        var _this = this;
        ...
        service.nearbySearch({
            ...
            if (status === google.maps.places.PlacesServiceStatus.OK) {
                for (var i = 0; i < results.length; i++) {
                    _this.GetPlceDetails(results[i]).then(function (res) {
                        _this.googleplaces.push(res);
                    });
                }
            }
        });
    };
    PlacesPage.prototype.GetPlceDetails = function (Place) {
        var _this = this;
        return new Promise(function (resolve) {
            ...
            _this.http.get('https://maps.googleapis.com/maps/api/place/details/json?key=' + _this.apikey + '&placeid=' + placeid).map(function (res) { return res.json(); }).subscribe(function (data) {
                ...
                if (_this.posts.photos) {
                    for (var i = _this.posts.photos.length - 1; i < _this.posts.photos.length; i++) {
                        ...
                        var distance = _this.location.getDistanceBetweenPoints(_this.posts.geometry.location, _this.params.location, 'km');
    ...
    PlacesPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_place_service__["a" /* Place */],
