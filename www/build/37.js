...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobsListPageModule", function() { return JobsListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__jobslist__ = __webpack_require__(1186);
...
var JobsListPageModule = (function () {
    ...
    JobsListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__jobslist__["a" /* JobsListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__jobslist__["a" /* JobsListPage */]),
...
//# sourceMappingURL=jobslist.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_jobslist_service__ = __webpack_require__(643);
...
var JobsListPage = (function (_super) {
    __extends(JobsListPage, _super);
    function JobsListPage(injector, renderer, admobFree, jobslistService, preference, popoverCtrl) {
        ...
        _this.params = {};
        _this.jobslists = [];
        _this.params.jobs = _this.navParams.get('jobs');
    ...
    JobsListPage.prototype.enableMenuSwipe = function () {
        return false;
    };
    JobsListPage.prototype.onImageLoad = function (imgLoader) {
        this.renderer.setElementClass(imgLoader.element, 'fade-in', true);
    };
    JobsListPage.prototype.prepareAd = function () {
    ...
    JobsListPage.prototype.openPopover = function (myEvent) {
    ...
    JobsListPage.prototype.goToJobsList = function (jobslist) {
        this.navigateTo('JobsListDetailPage', { jobslist: jobslist });
    };
    JobsListPage.prototype.loadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var jobslists, _i, jobslists_1, jobslist, err_1, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 4]);
                        return [4 /*yield*/, this.jobslistService.load(this.params)];
                    case 1:
                        jobslists = _a.sent();
                        for (_i = 0, jobslists_1 = jobslists; _i < jobslists_1.length; _i++) {
                            jobslist = jobslists_1[_i];
    ...
    JobsListPage.prototype.onLoadMore = function (infiniteScroll) {
        this.infiniteScroll = infiniteScroll;
        this.params.page++;
        this.loadData();
    };
    JobsListPage.prototype.onReload = function (refresher) {
    ...
    JobsListPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_core__["Injector"],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_jobslist_service__["a" /* JobsList */],
            __WEBPACK_IMPORTED_MODULE_5__providers_preference__["a" /* Preference */], __WEBPACK_IMPORTED_MODULE_0_ionic_angular__["o" /* PopoverController */]])
    ], JobsListPage);
    return JobsListPage;
