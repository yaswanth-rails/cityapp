...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddSaleListPageModule", function() { return AddSaleListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_salelist__ = __webpack_require__(1161);
...
var AddSaleListPageModule = (function () {
    function AddSaleListPageModule() {
    }
    AddSaleListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__add_salelist__["a" /* AddSaleListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_salelist__["a" /* AddSaleListPage */]),
    ...
    ], AddSaleListPageModule);
    return AddSaleListPageModule;
}());

//# sourceMappingURL=add-salelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddSaleListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_salelist_service__ = __webpack_require__(646);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_sale__ = __webpack_require__(658);
...
var AddSaleListPage = (function (_super) {
    __extends(AddSaleListPage, _super);
    function AddSaleListPage(injector, camera, geolocation, saleService, actionSheetCtrl, popoverCtrl) {
        var _this = _super.call(this, injector) || this;
        _this.camera = camera;
        _this.geolocation = geolocation;
        _this.saleService = saleService;
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormGroup */]({
            ...
            sale: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["g" /* Validators */].required),
    ...
    AddSaleListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    AddSaleListPage.prototype.ionViewDidLoad = function () {
    ...
    AddSaleListPage.prototype.openPopover = function (myEvent) {
    ...
    AddSaleListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.saleService.load().then(function (sale) {
            _this.sale = sale;
        }).catch(function (err) { return console.warn(err.message); });
    };
    AddSaleListPage.prototype.loadGoogleMaps = function () {
        var _this = this;
    ...
    AddSaleListPage.prototype.initMap = function () {
    ...
    AddSaleListPage.prototype.onSearchAddress = function (event) {
        var _this = this;
    ...
    AddSaleListPage.prototype.chooseImage = function (sourceType) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddSaleListPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddSaleListPage.prototype.prepareSaleListData = function () {
        var salelist = new __WEBPACK_IMPORTED_MODULE_3__providers_salelist_service__["a" /* SaleList */];
        salelist.title = this.form.value.name;
        salelist.sale = this.form.value.sale;
        salelist.description = this.form.value.description;
        salelist.address = this.form.value.address;
        salelist.website = this.form.value.website;
        salelist.phone = this.form.value.phone;
        salelist.image = this.image;
        if (this.location) {
            var position = {
                lat: this.location.lat,
                lng: this.location.lng
            };
            salelist.location = position;
        }
        return salelist;
    };
    AddSaleListPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, trans, trans, salelist, trans, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        _a.sent();
                        salelist = this.prepareSaleListData();
                        return [4 /*yield*/, salelist.save()];
                    case 8:
                        _a.sent();
                        this.form.reset();
