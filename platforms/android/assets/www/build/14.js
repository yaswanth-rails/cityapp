...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AddHomeServiceListPageModule", function() { return AddHomeServiceListPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_homeservicelist__ = __webpack_require__(1154);
...
var AddHomeServiceListPageModule = (function () {
    function AddHomeServiceListPageModule() {
    }
    AddHomeServiceListPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__add_homeservicelist__["a" /* AddHomeServiceListPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__add_homeservicelist__["a" /* AddHomeServiceListPage */]),
    ...
    ], AddHomeServiceListPageModule);
    return AddHomeServiceListPageModule;
}());

//# sourceMappingURL=add-homeservicelist.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AddHomeServiceListPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(72);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__base_page_base_page__ = __webpack_require__(1152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_homeservicelist_service__ = __webpack_require__(642);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_map_style__ = __webpack_require__(635);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_parse_file_service__ = __webpack_require__(633);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_homeservice__ = __webpack_require__(655);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_forms__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_camera__ = __webpack_require__(634);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_geolocation__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__app_app_config__ = __webpack_require__(256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_sweetalert__ = __webpack_require__(1153);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__concion_popover_concion_popover__ = __webpack_require__(632);
...
var AddHomeServiceListPage = (function (_super) {
    __extends(AddHomeServiceListPage, _super);
    function AddHomeServiceListPage(injector, camera, geolocation, popoverCtrl, homeserviceService, actionSheetCtrl) {
        var _this = _super.call(this, injector) || this;
        _this.camera = camera;
        _this.geolocation = geolocation;
        _this.popoverCtrl = popoverCtrl;
        _this.homeserviceService = homeserviceService;
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormGroup */]({
            ...
            homeservice: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["a" /* FormControl */](null, __WEBPACK_IMPORTED_MODULE_7__angular_forms__["g" /* Validators */].required),
    ...
    AddHomeServiceListPage.prototype.enableMenuSwipe = function () {
        return true;
    };
    AddHomeServiceListPage.prototype.ionViewDidLoad = function () {
    ...
    AddHomeServiceListPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.homeserviceService.load().then(function (homeservice) {
            _this.homeservice = homeservice;
        }).catch(function (err) { return console.warn(err.message); });
    };
    AddHomeServiceListPage.prototype.loadGoogleMaps = function () {
        var _this = this;
    ...
    AddHomeServiceListPage.prototype.openPopover = function (myEvent) {
        //this.navctrl.setRoot(CancionPopoverPage,{event})
        var popover = this.popoverCtrl.create(__WEBPACK_IMPORTED_MODULE_12__concion_popover_concion_popover__["a" /* CancionPopoverPage */]);
        popover.present({
            ev: myEvent
        });
    };
    AddHomeServiceListPage.prototype.initMap = function () {
    ...
    AddHomeServiceListPage.prototype.onSearchAddress = function (event) {
        var _this = this;
    ...
    AddHomeServiceListPage.prototype.chooseImage = function (sourceType) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddHomeServiceListPage.prototype.onUpload = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
    ...
    AddHomeServiceListPage.prototype.prepareHomeServiceListData = function () {
        var homeservicelist = new __WEBPACK_IMPORTED_MODULE_3__providers_homeservicelist_service__["a" /* HomeServiceList */];
        homeservicelist.title = this.form.value.name;
        homeservicelist.homeservice = this.form.value.homeservice;
        homeservicelist.description = this.form.value.description;
        homeservicelist.address = this.form.value.address;
        homeservicelist.website = this.form.value.website;
        homeservicelist.phone = this.form.value.phone;
        homeservicelist.image = this.image;
        if (this.location) {
            var position = {
                lat: this.location.lat,
                lng: this.location.lng
            };
            homeservicelist.location = position;
        }
        return homeservicelist;
    };
    AddHomeServiceListPage.prototype.onSubmit = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var trans, trans, trans, homeservicelist, trans, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 7:
                        _a.sent();
                        homeservicelist = this.prepareHomeServiceListData();
                        return [4 /*yield*/, homeservicelist.save()];
                    case 8:
                        _a.sent();
                        this.form.reset();
