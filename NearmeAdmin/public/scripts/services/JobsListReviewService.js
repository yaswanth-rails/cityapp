'use strict';
 angular.module('app')
 .factory('JobsListReview', function ($q) {

    var JobsListReview = Parse.Object.extend('JobsListReview', {

    }, {

      update: function (jobslistreview) {

        var defer = $q.defer();

        jobslistreview.save(null, {
      ...
      all: function (params) {
        ...
        query.find({
          success: function (jobslistreviews) {
            defer.resolve(jobslistreviews);
          },
          error: function (error) {
            defer.reject(error);
          }
    ...
    Object.defineProperty(JobsListReview.prototype, 'isInappropriate', {
      get: function () {
