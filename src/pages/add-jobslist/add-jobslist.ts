...
@IonicPage()
@Component({
  selector: 'page-add-jobslist',
  templateUrl: 'add-jobslist.html'
})
export class AddJobsListPage extends BasePage {
  ...
  constructor(injector: Injector,
    ...
    this.form = new FormGroup({
      ...
      jobs: new FormControl(null, Validators.required),
  ...
  ionViewDidEnter() {
    this.jobsService.load().then(jobs => {
      this.jobs = jobs;
  ...
  async onSubmit() {
    ...
    try {
      ...
      let jobslist = this.prepareJobsListData();
      await jobslist.save();
