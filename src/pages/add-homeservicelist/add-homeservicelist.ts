...
@IonicPage()
@Component({
  selector: 'add-homeservicelist',
  templateUrl: 'add-homeservicelist.html'
})
export class AddHomeServiceListPage extends BasePage {
  ...
  constructor(injector: Injector,
    ...
    this.form = new FormGroup({
      ...
      homeservice: new FormControl(null, Validators.required),
  ...
  ionViewDidEnter() {
    this.homeserviceService.load().then(homeservice => {
  ...
  prepareHomeServiceListData(): HomeServiceList {
    
    let homeservicelist = new HomeServiceList;
  ...
  async onSubmit() {
    ...
    try {
      ...
      let homeservicelist = this.prepareHomeServiceListData();
      await homeservicelist.save();
