...
@IonicPage()
@Component({
  selector: 'page-add-updatelist',
  templateUrl: 'add-updatelist.html'
})
export class AddUpdateListPage extends BasePage {
  ...
  constructor(injector: Injector,
    ...
    private updateService: CityUpdate,
  ...
  ionViewDidEnter() {
    this.updateService.load().then(cityupdate => {
  ...
  prepareUpdateListData(): UpdateList {
    
    let updatelist = new UpdateList;
  ...
  async onSubmit() {
    ...
    try {
      ...
      let updatelist = this.prepareUpdateListData();
