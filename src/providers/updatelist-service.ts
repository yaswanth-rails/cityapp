...
@Injectable()
export class UpdateList extends Parse.Object {
  ...
  like(updatelist: UpdateList) {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('likeUpdateList', { updatelistId: updatelist.id }).then(data => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isLiked(updatelist: UpdateList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isUpdateListLiked', { updatelistId: updatelist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isStarred(updatelist: UpdateList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isUpdateListStarred', { updatelistId: updatelist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  load(params: any = {}): Promise<UpdateList[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      query.find().then((data: UpdateList[]) => resolve(data), error => reject(error));
    });
  }

  loadFavorites(params: any = {}): Promise<UpdateList[]> {
...
Parse.Object.registerSubclass('UpdateList', UpdateList);
