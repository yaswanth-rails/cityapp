...
@Injectable()
export class HomeServiceList extends Parse.Object {

  constructor() {
    super('HomeServiceList');
  }
  ...
  like(homeservicelist: HomeServiceList) {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('likeHomeServiceList', { homeservicelistId: homeservicelist.id }).then(data => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isLiked(homeservicelist: HomeServiceList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isHomeServiceListLiked', { homeservicelistId: homeservicelist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isStarred(homeservicelist: HomeServiceList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isHomeServiceListStarred', { homeservicelistId: homeservicelist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  load(params: any = {}): Promise<HomeServiceList[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      query.find().then((data: HomeServiceList[]) => resolve(data), error => reject(error));
    });
  }

  loadFavorites(params: any = {}): Promise<HomeServiceList[]> {
...
Parse.Object.registerSubclass('HomeServiceList', HomeServiceList);
