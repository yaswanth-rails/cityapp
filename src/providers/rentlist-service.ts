...
@Injectable()
export class RentList extends Parse.Object {
  ...
  like(rentlist: RentList) {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('likeRentList', { rentlistId: rentlist.id }).then(data => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isLiked(rentlist: RentList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isRentListLiked', { rentlistId: rentlist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  isStarred(rentlist: RentList): Promise <boolean> {

    return new Promise((resolve, reject) => {
      Parse.Cloud.run('isRentListStarred', { rentlistId: rentlist.id }).then((data: boolean) => {
        resolve(data);
      }, error => {
        reject(error);
      });
  ...
  load(params: any = {}): Promise<RentList[]> {
    ...
    return new Promise((resolve, reject) => {
      ...
      query.find().then((data: RentList[]) => resolve(data), error => reject(error));
    });
  }

  loadFavorites(params: any = {}): Promise<RentList[]> {
...
Parse.Object.registerSubclass('RentList', RentList);
